            ...
            <div class="col-sm-12">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" href="Connexion.php">Connexion</a></li>
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                           <h2>Vous n'avez pas de compt ? <a href="page_inscription"><span class="theme_color">Inscrivez-vous gratuitement</span></a></h2>                
                        </div>
                    </div>
                </div>
            </div>
