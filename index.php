...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
          ...
          <div class="container">
            <div class="col-sm-12">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        <li><a class="nav-link active" href="Accueil.php">Accueil</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text white_fonts">
                                        <h3><strong>Le service notarial en ligne</strong><br>Créez gratuitement votre compte.</h3>
                                        <br>
                                        <a class="start_exchange_bt" href="Connexion.php">Inscrivez - vous ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pogoSlider-slide" style="background-image:url(images/slide_img.png);">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text white_fonts">
                                        <h3><strong>Avec Notarium,</strong><br>entrez en relation avec votre Notaire.</h3>
                                        <br>
                                        <a class="start_exchange_bt" href="Connexion.php">Inscrivez - vous  ></a>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 layout_padding">
                    <div class="full paddding_left_15">
                        <div class="heading_main text_align_left">
						   <h2><span class="theme_color">Une plateforme </span>dédiée aux clients des offices</h2>	
                        </div>
                    </div>
                    <div class="full paddding_left_15">
                        <p>La plateforme a pour objectif principal de simplifier la gestion de votre dossier, sans jamais se substituer au notaire.Désormer vous bénéficiez d'un accès rapide aux services de votre notaire, garant de l'efficacité et de la sécurité juridique des actes qu'il devra établir.</br></p>
                    </div>
                    <div class="full paddding_left_15">
                        <a class="main_bt" href="Connexion.php">Inscrivez-vous ></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                           <h2><span class="theme_color"></span>Domaines d'interventions des notaires</h2>    
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row margin-top_30">
                <div class="col-sm-12">
                    <div class="full">
                        <div class="center">
                            <a class="main_bt" href="#">CRÉER UN COMPTE ></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- end section -->
    <!-- section -->
    <div class="section white_fonts" style="background: #042b4a;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 layout_padding">
                    <div class="full paddding_left_15">
                        <div class="heading_main text_align_left">
                           <h2>Je dois régler une succession ou transmettre mon patrimoine</h2>    
                        </div>
                    </div>
                    <div class="full paddding_left_15">
                        <p>Vous êtes héritier et vous souhaitez confier le règlement de la succession à votre notaire.
                        Vous souhaitez organiser la transmission de vos biens.</p>
                    </div>
                    <div class="full paddding_left_15">
                        <a class="main_bt" href="#">CRÉER UN COMPTE ></a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="full paddding_left_15">
                        <div class="heading_main text_align_left">
                           <h2><span class="theme_color">Je vends</span> ou j'achète un bien immobilier</h2>    
                        </div>
                    </div>
                    <div class="full paddding_left_15">
                        <p>Vous vendez ou achetez un bien immobilier et vous souhaitez faire établir dans les meilleurs délais le compromis ou la promesse de vente.</p>
                    </div>
                    <div class="full paddding_left_15">
                        <a class="main_bt" href="#">CRÉER UN COMPTE ></a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                           <h2><span class="theme_color"></span>Le Kiosque des Notaires</h2>    
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                       ...
                       <div class="overlay"><a class="main_bt transparent" href="#">Lire la suite</a></div>
                       <div class="blog_details">
                         <h3>Conseils des notaires/Juillet 2020</h3>
                         <p>Relancez vos projets</p>
                       </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        ...
                        <div class="overlay"><a class="main_bt transparent" href="#">Lire la suite</a></div>
                       <div class="blog_details">
                         <h3>Conseils des notaires/Avril 2020</h3>
                         <p>Coronavirus : mon épargne est-elle en danger?</p>
                       </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        ...
                        <div class="overlay"><a class="main_bt transparent" href="#">Lire la suite</a></div>
                       <div class="blog_details">
                         <h3>Conseils des notaires/Mai 2020</h3>
                         <p>Le Guide de l'héritage et de la succession</p>
                       </div>
                    </div>
                </div>
             </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            ...
                            <div class="full">
                                <ul class="menu_footer">
                                    ...
                                    <li><a href="exchange.html">> Les notaires du réseau</a></li>
                                    <li><a href="services.html">> Les Partenaires</a></li>
