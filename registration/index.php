            ...
            <div class="col-sm-12">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="#">Procédure</a></li>
                        <li><a class="nav-link" href="#">Notaires du réseau</a></li>
                        <li><a class="nav-link" href="#">Partenaires</a></li>
                        <li><a class="nav-link" href="Connexion.html">Connexion</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner_title">
                        <h3><img width="5%" height="5%" src="images/logo Notarium Modifier 2.png">Mes dossiers</h3>
                    </div>
                </div>
                 <div class="barre_user sucess">
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                           <h2><span class="theme_color"></span>Nouveau dossier</h2> 
                    ...
                    <div class="full">
                        <form class="contact_form_inner" action="#">
                            <fieldset>
                                ...
                                <div class="field">
                                    <input type="text" name="phone_no" placeholder="Numero de téléphone" />
                                </div>
                                <div class="field">
