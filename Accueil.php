                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text white_fonts">
                                        ...
                                        <br>
                                        <a class="start_exchange_bt" href="exchange.html">Démarrer maintenant ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 layout_padding">
                    <div class="full paddding_left_15">
                        <div class="heading_main text_align_left">
                           <h2><span class="theme_color">Une plateforme </span>dédiée aux clients des officese</h2> 
                        </div>
                    </div>
                    <div class="full paddding_left_15">
                    ...
                    <div class="full paddding_left_15">
                        <a class="main_bt" href="#">Démarrer maintenant ></a>
                    </div>
                </div>
            </div>
        </div>
