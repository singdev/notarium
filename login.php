                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                           <h2>Vous n'avez pas de compt ? <a href="register.php"><span class="theme_color">Inscrivez-vous gratuitement</span></a></h2>                
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <form class="contact_form_inner" action="#" method="post" name="login">
                            <fieldset>
                                <div class="text_form">
                                    ...
                                    <input type="email" class="box-input" name="email" placeholder="Entrez votre adresse e-mail" />
                                </div>
                                <div class="text_form">
                                    <h1>Mot de passe : </h1>
                                   <input type="password" class="box-input" name="password" placeholder="Entrez votre mot de passe"> 
                                </div>
                                <div class="">
